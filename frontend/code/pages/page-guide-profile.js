    ...
    this.innerHTML = `
      ...
      <div class="page-guide-profile">
        ...
        <section class="guide-profile-header">
          <img
            src="${guide.profileImg || '../files/guide-img/default-profile.svg'}"
            alt="${guide.fullName}"
          ...
          <div class="guide-profile-info">
            ...
            <div class="guide-profile-meta">
              ...
              <div class="guide-meta-item">
                ...
                <span class="guide-meta-value"><a href="tel:${guide.phone.replace(/\s+/g, '')}">${guide.phone}</a></span>
              </div>
            ...
            <div class="guide-contact-section">
              <a href="tel:${guide.phone.replace(/\s+/g, '')}" class="guide-contact-btn">
                📞 Залгах
              </a>
...
customElements.define("page-guide-profile", PageGuideProfile);
